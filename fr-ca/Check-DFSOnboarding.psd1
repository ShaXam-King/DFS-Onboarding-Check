...
azureSubChoiceYN = Utilisez-vous uniquement cet abonnement pour comparer les serveurs intégrés ? (Y/N)
azureSubChoiceNums = Choisissez les abonnements par numéro (séparés par des virgules) (par exemple 1,3,4)
...
NameTShootMessage = Les serveurs ont une fonctionnalité DFS complète mais ont un double embarquement - Vérifiez la configuration de l'embarquement DFS
